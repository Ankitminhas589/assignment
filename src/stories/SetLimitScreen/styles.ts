...
export default StyleSheet.create({
    ...
    subtitleLogoStyle: {
        width: _scaleText(16).fontSize, height: _scaleText(16).fontSize
    },
    subtitleText: {
    ...
    quickfillButtonsMainContainer: {
        display: 'flex', flex: 1, flexDirection: 'row', marginTop: _scaleText(20).fontSize
    },
    quickfillButtonContainer: {
        ...
        backgroundColor: 'rgba(32, 209, 103, 0.1)', marginHorizontal: _scaleText(5).fontSize
    },
    quickillButtonText: {
    ...
    saveButtonContainer: {
        alignItems: 'center',
        position: 'absolute',
        bottom: _scaleText(50).fontSize,width:Dimensions.get('screen').width
    },
    saveButtonStyle: {
