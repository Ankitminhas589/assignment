    ...
    <ScreenComponent contentContainerStyle={styles.container}>
      ...
      <View style={styles.mainContentContainer}>
        <View style={styles.screenSubtitleContainer}>
          <Image
            resizeMode="contain"
            source={IMAGE_ASSETS.ICON_LIMIT_LIGHT}
            style={styles.subtitleLogoStyle}
          />
          <Text style={styles.subtitleText}>{CONSTANTS.SET_LIMIT_MESSAGE}</Text>
        </View>
        <CurrencyTextInputComponent
          value={value}
          onValueChange={setValue}></CurrencyTextInputComponent>
        ...
        <View style={styles.quickfillButtonsMainContainer}>
          <View style={styles.flex1}>
            <TouchableOpacity
              onPress={() => setValue('5,000')}
              style={styles.quickfillButtonContainer}>
        ...
        <View style={styles.saveButtonContainer}>
          <TouchableOpacity
            ...
            style={[
              ...
              {
                backgroundColor:
                  value && value != '' ? AppColors.APP_GREEN : AppColors.BUTTON_DISABLED,
              },
            ]}>
