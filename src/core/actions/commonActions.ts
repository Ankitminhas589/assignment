...
export function updateNetStatus(isConnected: boolean): actionsTypes.UpdateNetStatusActionType {
  return {
    type: actionsTypes.UPDATE_NET_STATUS,
    isConnected,
  };
}
export function updateAppUser(userData: UserData): actionsTypes.UpdateAppUserActionType {
  return {
